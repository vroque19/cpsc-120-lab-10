...
// Never, ever, ever, ever say 'using namespace std;' in a .h file.
...
class Person {
 ...
 public:
  /// Person is a constructor which initializes an empty Person object.
  /// A default constructor is needed for situations where you want to
  /// declare a variable without setting any of the data members to
  /// specific values.
  /// example:
  /// Person p;
  Person() = default;
  ...
  // Member functions are named like variable names when they are accessors and
  // mutators (get and set functions). Otherwise, member functions are named
  // like non-member function names. See
  // https://google.github.io/styleguide/cppguide.html#Function_Names and
  // https://google.github.io/styleguide/cppguide.html#Variable_Names.
...
// This is a non-member function which overloads the operator <<. This way, you
// can use an operator you already are familiar with to print a Person object to
// the terminal. Note that << is a binary operator which means it has two
// operands.
